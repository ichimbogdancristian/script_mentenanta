...
"@
        ...
        foreach ($log in $taskLogs) {
            ...
            # Improved task name readability for summary table and TOC
            ...
            $tocLinks += "<li style='margin-bottom:0.5em;'><a href='#${anchor}' style='font-weight:bold;color:#7fd1b9;text-decoration:none;'>$readableTask</a></li>"
        ...
        # Table of Contents
        $htmlHeader = $htmlHeader -replace "<span id='toc-links'></span>", "<ul style='list-style:none;padding-left:0;'>" + ($tocLinks -join "") + "</ul>"
